...
typedef enum McSAHStpAxParCkEnum
{	mcAHMRPSTAPC_NOT_USE = 0,
	mcAHMRPSTAPC_USE = 1
} McSAHStpAxParCkEnum;
...
typedef enum McSAMELOvercurrentErrReacEnum
{	mcSAMELOCER_ERRORSTOP = 0,
	mcSAMELOCER_WAR = 1,
	mcSAMELOCER_NONE = 2
} McSAMELOvercurrentErrReacEnum;

typedef enum McSAMELOvrTmpErrReacEnum
{	mcSAMELOTER_ERRORSTOP = 0,
	mcSAMELOTER_WAR = 1,
	mcSAMELOTER_NONE = 2
...
typedef struct McSAHStpAxParCkType
{	enum McSAHStpAxParCkEnum Type;
} McSAHStpAxParCkType;

typedef struct McSAHType
{	struct McSAHModType Mode;
	plcstring RestorePositionVariable[251];
	struct McSAHStpAxParCkType StpAxParCk;
...
{	double PositionError;
	...
	enum McSAMELOvercurrentErrReacEnum OvercurrentErrorReaction;
	enum McSAMELOvrTmpErrReacEnum OvertemperatureErrorReaction;
} McSAMELType;
