...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArCertCsrCreate		(*creates certificate signing request*)
	VAR_INPUT
		Execute			: BOOL; 			(*starts execution*) 			(**) (*#PAR*)
		Name 			: STRING[255];		(*name of the CSR*) 	(**) (*#PAR*)
		PrivateKeyName 	: STRING[255];		(*name of the private key*) 	(**) (*#PAR*)
		PrivateKeyPassword : STRING[255];	(*password of the private key*) (**) (*#PAR*)
		KeySize 		: ArCertSecureKeySizeEnum;(*size of key for certificate generation*) 	(**) (*#PAR*)
		CountryCode		: STRING[9];		(*country code*)		 		(**) (*#PAR*)
		StateProvince	: STRING[513];		(*state*) 						(**) (*#PAR*)
		Locality		: STRING[513];		(*locality*) 					(**) (*#PAR*)
		Organization 	: STRING[255];		(*organization*) 				(**) (*#PAR*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArCertCsrExport  			(*exports certificate signing request*)
	VAR_INPUT
		Execute			: BOOL; 			(*starts execution*) 			(**) (*#PAR*)
		Name 			: STRING[255];		(*name of the CSR*) 	(**) (*#PAR*)
		Data			: UDINT; 			(*pointer to buffer for exported CSR*) (**) (*#PAR*)
		DataSize		: UDINT;			(*buffer size*) 				(**) (*#PAR*)
	END_VAR
	VAR_OUTPUT
		Done			: BOOL;				(*execution done*) 				(**) (*#PAR*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArCertCsrGetDetails   	(*gets details of an certificate signing request*)
	VAR_INPUT
		Execute			: BOOL; 			(*starts execution*) 			(**) (*#PAR*)
		Name 			: STRING[255];		(*name of the CSR*) 	(**) (*#PAR*)
		Index			: UDINT;			(*index of the CSR*) (**) (*#PAR*)
	END_VAR
	VAR_OUTPUT
		Done			: BOOL;				(*execution done*) 				(**) (*#PAR*)
		Busy			: BOOL;				(*execution running*) 			(**) (*#PAR*)
		Error			: BOOL;				(*execution failed*) 			(**) (*#PAR*)
		StatusID		: DINT;  			(*execution error: see help*) 	(**) (*#PAR*)
		Details			: ArCertCsrDetailsType; (*CSR details*)
	END_VAR
	VAR
		Internal		: ArCertAsyncInternalType;	(*internal variable*)
	END_VAR
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArCertCsrDelete  				(*deletes certificate signing request*)
	VAR_INPUT
		Execute			: BOOL; 			(*starts execution*) 			(**) (*#PAR*)
		Name 			: STRING[255];		(*name of the CSR*) 	(**) (*#PAR*)
	END_VAR
