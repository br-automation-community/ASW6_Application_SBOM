 ...
 TYPE
	...
	ArCertCsrDetailsType : STRUCT				(*CSR details*)
		Name			: STRING[255]; 			(*CSR name*)
		Subject			: STRING[255];			(*subject (CN)*)		
		Version			: DINT;					(*version*)
	END_STRUCT;
    ...
    ArCertSecureKeySizeEnum :
        (
            arCERT_SECURE_KEY_SIZE_2048_BITS := 1,		(*encryption with a key with 2048 bits*)
            arCERT_SECURE_KEY_SIZE_4096_BITS := 2		(*encryption with a key with 4096 bits*)
        );
